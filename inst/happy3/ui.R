            ...
            dashboardBody(
                tabItems(
                    ...
                    tabItem(tabName = "conc",h3("Main Conclusions of the Analysis"),hr(),
                            ...
                            tags$li("Freedom of choice in a country seems to have a vry significant role in the well-being of a country."),
                            hr(),
                            h4("About Me"),
                            p("Debanjali Basu,MSc Data Science and Economics,Univrsity of Milan"),
                            br()
